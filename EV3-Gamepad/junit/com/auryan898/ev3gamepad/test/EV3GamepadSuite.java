...
public class EV3GamepadSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "com.auryan898.ev3gamepad.test.Test";

    public static void main(String args[]) {
        new TestSuite(EV3GamepadSuite.class).run(new TestResult());
    }
