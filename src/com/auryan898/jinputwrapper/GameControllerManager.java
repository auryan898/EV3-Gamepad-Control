...
public class GameControllerManager implements Runnable {
   ...
   */
  public GameController getRawController(int index) {
    try {
      return new GameController(this, this.players[index]);
   ...
   *                   controller buttons
   */
  public GameController getGameController(String primaryKey) throws Exception {
    GameController res = new GameController(this, primaryKey);
